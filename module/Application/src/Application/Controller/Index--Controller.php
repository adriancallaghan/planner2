...
class IndexController extends AbstractActionController
{
    public function indexAction()
    {
        ...
        */
        ...
        /*
         * GET TRANSACTION FROM date id 2
         */
        //var_dump($dateOrm->findOneById(2)->getActivities()->toArray()[0]->getTransaction()->toArray());
        
        
        /*
         * GET DATE FROM transaction id 6
         */
        //var_dump($transactionOrm->findOneById(6)->getActivities()[0]->getDate()->toArray());
       ...
       /*
        ...
        $newAcc = new \Application\Entity\Account();
        $newAcc->setOptions(array('name'=>'Dreams'));
        $em->persist($newAcc); // set data
        $em->flush(); // save   
        */
        ...
        $account = $accountOrm->findOneById(1);
        $transaction = $transactionOrm->findOneById(6);
