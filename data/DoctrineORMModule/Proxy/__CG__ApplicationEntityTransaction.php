 ...
 */
class Transaction extends \Application\Entity\Transaction implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function setReoccuring($reoccuring = false)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setReoccuring', array($reoccuring));

        return parent::setReoccuring($reoccuring);
    }
    ...
    public function getReoccuring()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getReoccuring', array());

        return parent::getReoccuring();
    }
