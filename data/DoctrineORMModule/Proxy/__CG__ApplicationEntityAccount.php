...
class Account extends \Application\Entity\Account implements \Doctrine\ORM\Proxy\Proxy
{
...
))
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setPayments', array($payment));

        return parent::setPayments($payment);
    }
     ...
     * {@inheritDoc}
     */
    public function removePayment(\Application\Entity\Payment $payment)
    {
     ...
     * {@inheritDoc}
     */
    public function addPayment(\Application\Entity\Payment $payment)
    {
